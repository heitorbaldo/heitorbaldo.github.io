...
* [TemporalHypermotifs](https://github.com/heitorbaldo/TemporalHypermotifs) - TemporalHypermotifs is a HyperNetX-based, open-source Python package for detecting, classifying, and quantifying temporal hypergraph motifs (THMs). It implements several measures to compute motif-level, single-layer hypergraph-level, and multilayer hypergraph-level features. 
