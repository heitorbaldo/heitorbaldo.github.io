...
Reconstruction of stimuli, intentions, and cognitive states from measured neural activity, covering both the encoding problem (how sensory and cognitive variables are represented) and the decoding problem (recovering those variables from recorded signals). This integrates the representational insights of the algebraic, manifold, and topological directions above with statistical and machine learning decoders, with relevance to brain computer interfaces (BCIs) and neurotechnology.
